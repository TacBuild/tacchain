...
tacchaind tx bank send validator "$NEW_ACCOUNT" 50000000000000000utac --gas 1000000 --gas-prices 25000000000utac -y -b sync -o json --keyring-backend=test --home $HOMEDIR | jq
sleep 6
