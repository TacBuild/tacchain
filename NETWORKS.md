...
| Snapshots                   | http://snapshot.tac.ankr.com/tac-{mainnet,spb}-{full,archive}-latest.{tar.lz4,shasum}   |
...
**1) I have completed the guide to join as a validator, but my node is not in the active validator set?**
